  // ------------------------------------------------- Get the modal -----------------------------
        ...
        let lastItem; //définit lastItem sans lui donner de valeur (variable vide)
       ...
       //defini deux parametres min/max ici (on leurs donnera une valeur quand la fonction sera appellée dans show()), les images aparaitront aleatoirement pendant le temps compris entre ces valeurs.
        ...
        //on crée un tableau avec toutes le nom des sources des images
       ...
       // on choisi aleatoirement un item dans une liste 
        function randomItem(items) {
            ...
            if (item === lastItem) { //si l'item choisi correspond au dernier item choisi on rejoue la fonction

                return randomItem(items);
            }
            lastItem = item; // le dernier choisi définit en tant qu'item
            return item;
        ...
        function show() {
            ...
            //choisi un element d'une liste au hasard
...
// ------------------------------------------------- Click event -----------------------------
 ...
 // ------------------------------------------------- CURSOR -----------------------------
        ...
        // on récupère dans une variable l'image qui remplacera le curseur fleche
...
// ------------------------------------------------- TIMER -----------------------------
        ...
        // fonction d'affichage du format du timer
        ...
        // fonction qui appelle la fonction timer 
        function launch_count_down() {
            // on récupère dans une variable la div count_down_div
